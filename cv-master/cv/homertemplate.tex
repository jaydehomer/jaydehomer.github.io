...
%website
$if(www)$\faicon{user} \href{http://$www$}{$www$}\hspace{1 mm} $endif$%
}
...
% \pagestyle{fancy}
% \makeatletter
% \lhead{\sf\textcolor{gray}{$if(docname)$$docname$$else$Curriculum Vitae$endif$: \@name}}
% \rhead{\sf\textcolor{gray}{\thepage}}
% \cfoot{}
% \def\headrule{\hbox to \headwidth{\color{gray}\leaders\hrule height \headrulewidth\hfill}}
% \makeatother
